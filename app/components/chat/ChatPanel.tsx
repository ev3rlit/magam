...
export const ChatPanel: React.FC = () => {
  ...
  useEffect(() => {
    if (isOpen && providers.length === 0 && status !== 'loadingProviders') {
      void loadProviders();
    }
  }, [isOpen, providers.length, status, loadProviders]);
  ...
  return (
    <aside className="absolute right-4 top-16 bottom-4 z-40 w-[360px] max-w-[calc(100%-2rem)] rounded-xl border border-slate-200 bg-white shadow-xl dark:border-slate-700 dark:bg-slate-900 flex flex-col overflow-hidden">
