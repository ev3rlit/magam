...
5. pseudo, responsive, dark variant 지원 범위를 이번 문서에서 무조건 v1 필수로 확정하지 않는다.
...
- variant 일부 지원 (`hover:`, `dark:`, `md:` 등 중 제한된 subset)
...
2. pseudo/responsive/dark variant를 v1에 포함할 것인가
