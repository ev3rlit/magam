...
- Variant-prefixed tokens currently support `hover:`, `focus:`, `active:`, `dark:`, `md:`, `lg:`, `xl:`, and `2xl:` within the runtime surface.
- `hover:`, `focus:`, and `active:` tokens are emitted into dedicated interaction style layers instead of being folded into the base inline style payload.
